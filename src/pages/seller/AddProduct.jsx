...
// ──────────────────────────────────────────────────────────────────
// Seller ka "Add Product" form. Submit hote hi product localStorage
// me save hota hai (sellerStore) aur turant Redux products list me
// bhi push ho jaata hai — isliye /products page pe turant "live"
// dikhega, bina refresh ke.
// ──────────────────────────────────────────────────────────────────
...
import { addSellerProduct } from "../../utils/sellerStore";
...
const EMPTY_FORM = {
  title: "", brand: "", category: CATEGORIES[0], description: "",
  ...
  return (
    <div className="max-w-[720px] mx-auto">
      ...
      <p className="text-[13px] mb-8" style={{ color: "var(--white)" }}>
        Fill in the details below. Your product will go live on SanVora as soon as you submit.
      </p>
          ...
          {success ? (
            <motion.div key="success" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-8">
              ...
              <p className="text-[13px] mb-6" style={{ color: "var(--muted)" }}>
                Your product is now visible on the Products page.
              </p>
              <div className="flex items-center justify-center gap-3">
                <button
                  onClick={() => setSuccess(false)}
                  className="px-5 h-11 rounded-full text-[13px] font-semibold"
