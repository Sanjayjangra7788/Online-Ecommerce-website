...
function Login() {
  ...
  const res = await fetch("/api/login", {
    ...
    credentials: "include", // zaroori — httpOnly cookie set/receive karne ke liye
  });
  ...
  // Token ab kabhi frontend me aata hi nahi — httpOnly cookie me set ho chuka hai.
  // Sirf user profile Redux me jaata hai.
  dispatch(loginSuccess({
    user: {
      id: data.user.sub,
      name: data.user.name,
